    ...
    <div className="min-h-screen flex items-center justify-center bg-gkd-bg">
      <div className="max-w-md w-full px-6">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gkd-text mb-2">
            Gemini Knowledge Drive
          </h1>
          <p className="text-gkd-text-muted">
            Transform your Google Drive into a knowledge base
          </p>
        </div>
        ...
        <div className="bg-gkd-surface rounded-lg p-8 border border-gkd-border">
          ...
          <p className="mt-4 text-xs text-center text-gkd-text-muted">
