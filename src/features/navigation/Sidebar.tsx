...
import { AnalyticsPanel } from '@/features/graph';
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-auto">
        ...
        {sidebarMode === 'graph' && <AnalyticsPanel />}
        {sidebarMode === 'starred' && (
      ...
      <div className="border-t border-gkd-border px-3 py-2 flex items-center justify-between">
        <button
          onClick={onOpenSettings}
          className="text-sm text-gkd-text-muted hover:text-gkd-text transition-colors flex items-center gap-2"
          title="Settings (Cmd+,)"
        >
